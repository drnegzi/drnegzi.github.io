...
summary: شاید برای شما هم اتفاق افتاده باشه که در بعضی از برنامه‌های C و ++C با تابع ()void main مواجه بشید، آیا استفاده از این تابع درسته؟ تفاوت بین ()int main و ()void main در چیست؟ و از کدام باید استفاده کنیم؟ در این مطلب قصد دارم با بیانی طنز، به رفع ابهام در این مورد بپردازم.
excerpt_separator: <!--more--> 
uuid: d8b47e35-602d-48a8-94e2-428c4fcdd4e0
comments: true
series: 
description: شاید برای شما هم اتفاق افتاده باشه که در بعضی از برنامه‌های C و ++C با تابع ()void main مواجه بشید، آیا استفاده از این تابع درسته؟ تفاوت بین ()int main و ()void main در چیست؟ و از کدام باید استفاده کنیم؟ در این مطلب قصد دارم با بیانی طنز، به رفع ابهام در این مورد بپردازم. تابع int main() چطور؟
---
