...
comments: true
series: 
description: شاید برای شما هم اتفاق افتاده باشه که در بعضی از برنامه‌های C و ++C با تابع ()void main مواجه بشید، آیا استفاده از این تابع درسته؟ تفاوت بین ()int main و ()void main در چیست؟ و از کدام باید استفاده کنیم؟ در این مطلب قصد دارم با بیانی طنز، به رفع ابهام در این مورد بپردازم.
---
