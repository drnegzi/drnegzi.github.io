...
<ul class="top-level-list list-style-type-disc">
<li class="margin-right-25px">تنها دارای یک جواب، در صورتی که شیب دو خط با هم برابر باشند.</li>
...
توپی روی صحفه در حال حرکت  در مسیری صاف و مستقیم است و با معادله <span>-۲ = -x + ۲y</span> مشخص می‌شود، و محل قرار گیری دیوار هم روی خطی به معادله <span>۶- = ۳x - ۶y</span> است. آیا این توپ با دیوار برخورد خواهد کرد؟
