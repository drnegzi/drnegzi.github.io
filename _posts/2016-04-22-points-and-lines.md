...
از آنجایی که معادلات خطوطی که قصد بررسی آنها را داریم، مشخص هستند، می‌توانیم با کنار هم قرار دادن آنها یک [دستگاه معادلا خطی](https://en.wikipedia.org/wiki/System_of_linear_equations) ایجاد کنیم. برای یافتن پاسخ موضوع مطرح شده در بالا، حالاتی مختلفی که ممکن است جواب این دستگاه داشته باشد را بررسی می‌کنیم و سپس راه حل‌های برای مقدار عددی این دستگاه ارائه می‌کنیم.
